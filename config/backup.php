...
return [
    ...
    /*
     * The paths that will be excluded from the backup.
     * These paths will not be included in the backup.
     * You can use this to exclude directories that are not needed in the backup.
     */
    'exclude' => [
        base_path('vendor'),
        base_path('node_modules'),
